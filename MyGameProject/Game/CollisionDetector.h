...
public:
	...
	//
	static float SweptAABB(Entity* ent1, Entity* ent2, Entity::SideCollision& side, double dt = SPF);
	static float SweptAABB(BoxCollider r1, D3DXVECTOR2 oriVel1, BoxCollider r2, D3DXVECTOR2 oriVel2, Entity::SideCollision& side, double dt = SPF);
	//board-phasing 
